...
if (GetLocale()=="frFR") then
  ...
  LOOTHOG_OPTION_AUTOOFFSPEC = "Automatically announce offspec if no-one rolls"
	...
	LOOTHOG_OPTION_ANNOUNCEONCLEAR = "Annonce apres Start:"
	...
	LOOTHOG_MSG_OFFSPEC_ACK = "roll enregistrer offspec (%s). bonne chance" -- (roll)
...
-- I don't know if a literal substitution can provide a proper translation. Feedback is welcome. :)
	...
	LOOTHOG_ABOUT_THANKS2 = "Suan (Kaz'goroth) - Coding, German Translation"
