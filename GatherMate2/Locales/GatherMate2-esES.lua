...
--@localization(locale="esES", format="lua_additive_table", namespace="Options", table-name="L", handle-unlocalized="comment")@
...
--@localization(locale="esES", format="lua_additive_table", namespace="Nodes", table-name="NL", handle-unlocalized="comment")@
