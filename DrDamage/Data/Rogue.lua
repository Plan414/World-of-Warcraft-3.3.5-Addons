...
--Target
	--Deadly Poison
	self.TargetAura[GetSpellInfo(2818)] = { ActiveAura = "Deadly Poison", Spells = { 32645, 1329 }, Manual = GetSpellInfo(2818), Category = "Deadly Poison", SelfCast = true, Apps = 5, ID = 2818 }
