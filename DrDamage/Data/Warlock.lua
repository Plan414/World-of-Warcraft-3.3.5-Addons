...
--Custom
	...
	self.PlayerAura[GetSpellInfo(23785)] = { School = { ["Fire"] = true, ["Shadow"] = true }, ActiveAura = "Master Demonologist", NoManual = true, ModType =
		function ( calculation, _, Talents )
			if calculation.school == "Fire" and PetSpellInfo(imp) or calculation.school == "Shadow" and PetSpellInfo(succubus) then
	...
	self.spellInfo = {
		...
		[GetSpellInfo(1454)] = { --DONE: Base OK, Increase X, Coefficient OK
					--TODO: 3.3.3 - Increase
					["Name"] = "Life Tap",
					...
					[1] = { 41, 41, 0, 0, spellLevel = 6, },
					[2] = { 86, 86, 0, 0, spellLevel = 16, },
					[3] = { 159, 159, 0, 0, spellLevel = 26, },
					[4] = { 249, 249, 0, 0, spellLevel = 36, },
					[5] = { 346, 346, 0, 0, spellLevel = 46, },
					[6] = { 867, 867, 0, 0, spellLevel = 56, },
					[7] = { 1164, 1164, 0, 0, spellLevel = 68, },
					[8] = { 2000, 2000, 0, 0, spellLevel = 80, },
		},
