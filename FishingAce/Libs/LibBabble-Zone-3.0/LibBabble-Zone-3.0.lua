...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 248 $"):match("%d+"))
...
elseif GAME_LOCALE == "deDE" then
	...
	["Halls of Reflection"] = "Hallen der Reflexion", -- Needs review
...
elseif GAME_LOCALE == "koKR" then
	...
	["The Frozen Halls"] = "얼어붙은 전당", -- Needs review
	...
	["The Scarlet Enclave"] = "진홍빛 전당", -- Needs review
